...
${BOTAO_CONFIRM}            xpath=//input[@class='button-1 confirm-order-next-step-button']
${BOTAO_CONTINUE_ADDRESS}   xpath=(//input[@class='button-1 new-address-next-step-button'])[1]
${BOTAO_CONTINUE_SHIPPING}  xpath=(//input[@class='button-1 new-address-next-step-button'])[2]
...
${SET_ORDEMPGTO}            id=paymentmethod_3
${CHECKBOX_TERMS}           id=termsofservice
